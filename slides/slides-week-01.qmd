...
1. The Elephant in the Room: AI

1. Next Week

::: {.notes}
https://rin3fall2026.rfortherestofus.com/slides/slides-week-01.html
:::
...
participants <-
  read_sheet(
    "https://docs.google.com/spreadsheets/d/1Rz7_1_CzxURdhPHRj9YAzV-tgQP6xQmY_qV0VPjhPYs/edit?gid=1336781162",
    sheet = "Fall 2026 Participants"
  ) |>
  clean_names()
...
[![](assets/course-materials.png)](https://rfortherestofus.com/courses/r-in-3-months-fall-2026)
...
[![](assets/project-assignment-example.png)](https://rfortherestofus.com/courses/r-in-3-months-fall-2026/lessons/fall-2026-week-2-project-assignment)
...
::: {.absolute top=0 right=-225}
{{< countdown "1:00" top=0 right=0 >}}
:::

Which approach would you use to understand what variables a dataset contains and what type of information each variable holds?

1. Use `library()` to see the variables and their types.

2. Use `glimpse()` to examine the structure of the dataset.

3. Use `install.packages()` to examine the dataset.

4. Use `setwd()` to display the variables and their types.
...
2. [Use `glimpse()` to examine the structure of the dataset.]{.mark}
...
# The Elephant in the Room: AI {.inverse}

::: {.notes}
https://datavizf25.classes.andrewheiss.com/news/2025-11-02_llms-bad-for-learning-code.html

https://www.andrewheiss.com/ai/

https://datavizf25.classes.andrewheiss.com/news/2025-12-10_faqs_week-15.html
:::
