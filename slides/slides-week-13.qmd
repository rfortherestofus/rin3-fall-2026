...
::: notes
https://rin3spring2026.rfortherestofus.com/slides/slides-week-13.html

https://rfortherestofus.com/courses/r-in-3-months-spring-2026/lessons/r-in-3-months-progress-survey
:::
...
::: {.notes}
https://docs.google.com/presentation/d/1kDRwjcJP-qjrmSNgkEIGmhg9imfhGWks81-9JANpQog
:::
...
## {background-video="assets/AllyLogo.mp4" background-video-loop="true" background-size="contain"}
...
2.  Use `reprex::reprex_addin()` to open an interactive menu to create a reprex

3.  Choose the options for where you're asking your question

4.  Copy the output and paste it wherever you want to get help
...
1. Ally launching later this summer!
